const zhMessages = {
  ...
  ImportAppCodeLabel: '所属应用',
  ImportDryRunLabel: '仅校验（Dry-run）',
  ImportFileLabel: '文件',
  ImportFilePlaceholder: '请选择 JSON 文件',
  ImportSubmitLabel: '开始导入',
  ImportSuccessNotice: '导入成功',
  ImportFailedNotice: '导入失败',
  ImportResultCreated: '新增',
  ImportResultUpdated: '更新',
  ImportResultReactivated: '复活',
  ...
  AvatarLabel: '头像',
  TenantInitializeButtonLabel: '初始化',
  TenantInitializeTitle: '初始化租户',
  TenantInitializeSuccess: '初始化成功',
  TenantInitOrgSectionTitle: '组织信息',
  TenantInitUserSectionTitle: '用户信息',
  TenantInitInfoTitle: '初始化信息',
  InitializedLabel: '是否已初始化',
